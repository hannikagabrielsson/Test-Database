...
namespace webapi.Controllers
{
    ...
    {
        private readonly HannikaTesti061123Context _context;

        public PersonController(HannikaTesti061123Context context)
        {
            _context = context;
        }
        ...
        public IEnumerable<Person> Index()
        {
            ...
            // Problem("Entity set 'HannikaTesti061123Context' is null.");
        }
